...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() 
  {
    ...
    {
      drive.tankDrive(-joystick.getY(Hand.kLeft) * 0.5f, -joystick.getY(Hand.kRight) * 0.5f, true);
    }
    ...
    if (joystick.getAButtonPressed())
    {
      if (s1.get() == Value.kForward)
      {
        ...
        SmartDashboard.putBoolean("Tray", false);
      }
      else
      {
        s1.set(Value.kForward);
        SmartDashboard.putBoolean("Tray", true);
      }
    }
    ...
    if (joystick.getBButtonPressed())
    {
      if (s2.get() == Value.kForward)
      {
        ...
        SmartDashboard.putBoolean("Hook", false);
      }
      else
      {
